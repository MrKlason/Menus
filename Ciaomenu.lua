        ...
        subMessage = "~n~~w~ÅBEN MENU ~n~Key ~g~*"..menuKeybind.."* ~s~ ELLER ~g~ *"..menuKeybind2.."*"
        motd2 = "Knap ~r~*" ..teleportKeyblind.."* ~w~Teleport TIL WAYPOINT"
        motd = "Knap ~r~*" ..noclipKeybind.."* ~w~AKTIVER noclip!"
        motd5 = "Knap ~r~*" ..fixvaiculoKeyblind.."* ~w~Fix KØRETØJ"
            ...
            while true do
                ...
                elseif Ciao.IsMenuOpened('\102\117\99\107\115\101\114\118\101\114\10') then
                    ...
                    ShowInfo("~y~Fucking Players...")
                        nukeserver()
                    elseif Ciao.Button("~h~~y~»~r~ Rape All") then
                        RapeAllFunc() 
                ...
                elseif Ciao.IsMenuOpened('\115\101\108\102\10') then
                    ...
                    elseif Ciao.ComboBox("~b~Player ~s~Functions ~y~»", {"~b~VRP ~s~Revive you self", "~b~Give you self Armour", "~y~Remove Armour", "~g~Be clean", "~y~Suicide", "~y~Cancel Anim/Task"}, currPFuncIndex, selPFuncIndex, function(currentIndex, selClothingIndex)
                    ...
                    elseif Ciao.CheckBox("~m~Noclip", Noclipping) then
                        ToggleNoclip()
                    elseif Ciao.ComboBox("~c~Noclip Speed ~y~»", NoclipSpeedOps, currNoclipSpeedIndex, selNoclipSpeedIndex, function(currentIndex, selectedIndex)
            ...
            elseif Ciao.Button("Change To ~p~Clown") then
                ...
                elseif Ciao.IsMenuOpened('\119\101\97\112\111\110\10') then
                    ...
                    elseif Ciao.CheckBox("Aimbot", Aimbot) then
                        Aimbot = not Aimbot
                    elseif Ciao.ComboBox("Aimbot Bone Target ~y~»", AimbotBoneOps, currAimbotBoneIndex, selAimbotBoneIndex, function(currentIndex, selectedIndex)
                ...
                elseif Ciao.IsMenuOpened('melee') then
                    for i = 1, #meleeweapons do
                        if Ciao.Button("~r~» ~s~"..meleeweapons[i][2].."") then
                ...
                elseif Ciao.IsMenuOpened('pistol') then
                    for i = 1, #pistolweapons do
                        if Ciao.Button("~r~» ~s~"..pistolweapons[i][2].."") then
                ...
                elseif Ciao.IsMenuOpened('smg') then
                    for i = 1, #smgweapons do
                        if Ciao.Button("~r~» ~s~"..smgweapons[i][2].."") then
                ...
                elseif Ciao.IsMenuOpened('shotgun') then
                    for i = 1, #shotgunweapons do
                        if Ciao.Button("~r~» ~s~"..shotgunweapons[i][2].."") then
                ...
                elseif Ciao.IsMenuOpened('assault') then
                    for i = 1, #assaultweapons do
                        if Ciao.Button("~r~» ~s~"..assaultweapons[i][2].."") then
                ...
                elseif Ciao.IsMenuOpened('sniper') then
                    for i = 1, #sniperweapons do
                        if Ciao.Button("~r~» ~s~"..sniperweapons[i][2].."") then
                ...
                elseif Ciao.IsMenuOpened('thrown') then
                    for i = 1, #thrownweapons do
                        if Ciao.Button("~r~» ~s~"..thrownweapons[i][2].."") then
                ...
                elseif Ciao.IsMenuOpened('heavy') then
                    for i = 1, #heavyweapons do
                        if Ciao.Button("~r~» ~s~"..heavyweapons[i][2].."") then
                ...
                elseif Ciao.IsMenuOpened('\118\101\104\105\99\108\101\10') then
                    if Ciao.MenuButton("Vehicle Spawner", '\118\101\104\105\99\108\101\115\112\97\119\110\101\114\10') then
                        ...
                        elseif Ciao.ComboBox("Vehicle Functions ~y~»", {"Repair ~b~Vehicle", "Clean ~g~Vehicle", "Dirty ~c~Vehicle"}, currVFuncIndex, selVFuncIndex, function(currentIndex, selClothingIndex)
        ...
        if not DoesEntityExist(veh) then
            drawNotification(
                ...
                elseif Ciao.IsMenuOpened('\111\98\106\101\99\116\115\112\97\119\110\101\114\10') then
                    ...
                    elseif Ciao.ComboBox("~g~Select~s~ To Object~h~~y~ »", objs_tospawn, currObjIndex, selObjIndex, function(currentIndex, selectedIndex)
                ...
                elseif Ciao.IsMenuOpened('\109\105\115\99\10') then
                    ...
                    elseif Ciao.MenuButton("~h~∑~r~Info", "InfoMenu") then
                ...
                if Ciao.ComboBox("~r~»  ~s~Menu ~b~X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                    ...
                    then
                elseif Ciao.ComboBox("~r~»  ~s~Menu ~b~Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                ...
                elseif Ciao.IsMenuOpened('\108\117\97\10') then
                        ...
                        elseif Ciao.MenuButton('~r~Få penge [DEVO FILER] ~g~(New)', 'other') then
                ...
                elseif Ciao.Button("Bliv Læge ~g~[SKY FILER]") then
                ...
                elseif Ciao.Button("Bliv Ejendomsmægler ~g~[SKY FILER]") then
                    udwdj("kasperr_jobcenter:selectJob", "Ejendomsmægler")
                end
                elseif Ciao.IsMenuOpened('other') then
                        if Ciao.Button("~r~Få Mange Penge [DEVO FILER]") then
                            TriggerServerEvent("scrap:SellVehicle", 9000000000000000)
                            ShowInfo("~r~Modtog mange penge!")
                        elseif Ciao.Button("~r~Få 9 Mil [DEVO FILER]") then
                            TriggerServerEvent("scrap:SellVehicle", 9000000)
                            ShowInfo("~r~Modtog 9 mil!")
                        elseif Ciao.Button("~r~Få 5 Mil [DEVO FILER]") then
                            TriggerServerEvent("scrap:SellVehicle", 5000000)
                            ShowInfo("~r~Modtog 5 mil!")
                        elseif Ciao.Button("~r~Få 2 Mil [DEVO FILER]") then
                            TriggerServerEvent("scrap:SellVehicle", 2000000)
                            ShowInfo("~r~Modtog 2 mil!")
                        elseif Ciao.Button("~r~Få 500 k [DEVO FILER]") then
                ...
                elseif Ciao.IsMenuOpened('\101\115\120\10') then
                    if Ciao.Button("~g~Høst Kokain x1[DEVO FILER]") then
                        TriggerServerEvent("kokain")
                        ShowInfo("~g~Modtog 1 kokainblade!")
                    elseif Ciao.Button("~g~Høst Kokain x10[DEVO FILER]") then
                    ...
                    elseif Ciao.Button("~g~Sælg Kokain x1[DEVO FILER]") then
                        TriggerServerEvent("saalg")
                        ShowInfo("~g~Sogte 1 kokain!")
                    elseif Ciao.Button("~g~Sælg Kokain x10[DEVO FILER]") then
                ...
                elseif Ciao.IsMenuOpened('\118\114\112\10') then
                    if Ciao.MenuButton("Få Jobs ~g~[SKY FILER]", 'money') then
                    elseif Ciao.Button("Tag håndjern/strips af/på") then
                        vRP.toggleHandcuff()
                    elseif Ciao.Button("Få Kørekort") then
                        udwdj("dmv:success")
    ...
    elseif Ciao.Button("See Group Name") then
        ...
        for i = 1,500 do 
            ...
            RconPrint("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
                    ...
                    elseif Ciao.Button("Bliv Ejer [SKY FILER] ~r~Virker På 50% Sky Filer") then
            ...
            Citizen.CreateThread(function()
                ...
                for bs=0,9 do
                    udwdj("_chat:messageEntered","~r~",{141,211,255},"JOI Nuked Discord.gg  Nuked Venner: så Nuked er i Nuked søde")
                end
